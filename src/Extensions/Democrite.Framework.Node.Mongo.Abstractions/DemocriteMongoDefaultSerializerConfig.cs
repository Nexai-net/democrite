...
namespace Democrite.Framework.Node.Mongo.Abstractions
{
    using Democrite.Framework.Node.Mongo.Abstractions.Conventions;
    using Democrite.Framework.Node.Mongo.Abstractions.Serializers;
