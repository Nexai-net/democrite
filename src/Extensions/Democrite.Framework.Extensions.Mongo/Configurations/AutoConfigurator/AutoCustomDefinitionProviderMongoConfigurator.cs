...
namespace Democrite.Framework.Extensions.Mongo.Configurations.AutoConfigurator
{
    ...
    public sealed class AutoCustomDefinitionProviderMongoConfigurator : INodeCustomDefinitionProviderAutoConfigurator
    {
        /// <inheritdoc />
                                  ...
                                  string targetKey)
        {
            ...
            builder.SetupDefinitionStorage(targetKey);
        }
    }
}
