...
namespace Democrite.Framework.Extensions.Mongo.Configurations.AutoConfigurator
{
    ...
    public sealed class AutoDemocriteDynamicDefinitionsMongoConfigurator : INodeDemocriteDynamicDefinitionsMemoryAutoConfigurator
    {
        /// <inheritdoc />
        public void AutoConfigure(IDemocriteNodeMemoryBuilder democriteBuilderWizard, IConfiguration configuration, IServiceCollection serviceCollection, ILogger logger)
        {
