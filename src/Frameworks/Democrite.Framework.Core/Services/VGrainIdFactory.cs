...
namespace Democrite.Framework.Core.Services
{
    ...
    public sealed class VGrainIdFactory : SafeDisposable, IVGrainIdFactory
    {
        ...
        /// <summary>
        /// Initialize the class <see cref="VGrainIdFactory"/>
        /// </summary>
        static VGrainIdFactory()
        {
        ...
        /// <inheritdoc />
        public IVGrainId BuildNewId<TVGrain>(object? input,
                                   ...
                                   ILogger? logger = null)
        {
            ...
            var formatAttribute = vgrainType.GetCustomAttribute<VGrainIdFormatAttribute>(false) ?? VGrainIdFormatAttribute.Default;
