...
namespace Democrite.Framework.Node.Abstractions.Artifacts
{
    ...
    /// <summary>
    /// Provider used to get <see cref="ArtifactDefinition"/> from <see cref="IArtifactProviderSource"/>
    /// </summary>
    /// <seealso cref="IProviderStrategy{IArtifactResource, Guid}" />
    public interface IArtifactProvider : IProviderStrategy<ArtifactDefinition, Guid>
    {
    }
}
